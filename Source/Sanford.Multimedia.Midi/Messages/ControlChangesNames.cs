...
namespace Sanford.Multimedia.Midi.Core.Sanford.Multimedia.Midi.Messages
{
    /// <summary>
    /// Provides names for all 128 MIDI Control Change messages.
    /// </summary>
    public struct ControlChangesNames
    {
